...
```{r}
boxplot(kobe_streak)
# Answer: E is False ( the shortest streak is actually 0)
```
...
```{r}
#Answer: A. Given the simulation is bases on a .45% probablity and the distribution looks similar to the kobe_streak it does not appear to be evidence for the hot hand. 
```
